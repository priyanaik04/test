...
import 'package:chatapp/messaging/group_info.dart';
...
class _MessageScreenState extends State<MessageScreen> {
  ...
  void initState() {
    ...
    if (widget.isGroup) {
      ...
      readAll(isGroup: false, groupName: widget.email, data: widget.data);
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    Stream<QuerySnapshot> stream = widget.isGroup
        ...
        : FirebaseFirestore.instance
            .collection(
                "Messages/${widget.data.email}/Messages/${widget.email}/Messages")
            .orderBy('time', descending: true)
            .snapshots(includeMetadataChanges: true);
                                      ...
                                      TextButton(
                                        ...
                                        onPressed: () {
                                          for (var element in set) {
                                            FirebaseFirestore.instance
                                                .doc(
                                                    "Messages/${widget.data.email}/Messages/${widget.email}/Messages/$element")
                                                .delete();
                                          }
                                          setState(() {
                                            set.clear();
                                          ...
                                          ? TextButton(
                                              ...
                                              onPressed: () {
                                                for (var element in set) {
                                                  ...
                                                  FirebaseFirestore.instance
                                                      .doc(
                                                          "Messages/${widget.email}/Messages/${widget.data.email}/Messages/$element")
                                                      .delete();
                                                }
                                                setState(() {
                                                  set.clear();
                    ...
                    if (snapshot.hasData) {
                      if (snapshot.data!.docs.isNotEmpty) {
                        ...
                        if (widget.isGroup) {
                          ...
                          // on reciver
                          FirebaseFirestore.instance
                              .collection("Messages/${widget.email}/Messages")
                            ...
                            if (widget.isGroup) {
                                      ...
                                      FirebaseFirestore.instance
                                        ...
                                        if (userdocs.docs.isNotEmpty &&
                                          ...
                                          NotificationAPI.postNotification(
                                              ...
                                              message:
                                                  "  ${widget.data.name["First"].toString()}: ${MessageScreen.myController.text}",
                              ...
                              FirebaseFirestore.instance
                                  ...
                                  .then((value) => {
                                        ...
                                        FirebaseFirestore.instance
                                            .collection(
                                                "Messages/${widget.email}/Messages/${widget.data.email}/Messages")
                                            .doc(value.id)
                              ...
                              if (receiver.isNotEmpty) {
                                NotificationAPI.postNotification(
                                    title:
                                        "${widget.data.name['First'].toString()} ${widget.data.name['Last'].toString()}",
                                    message: MessageScreen.myController.text,
                                    receiver: receiver);
                              }
                            }
