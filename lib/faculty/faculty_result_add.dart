import 'dart:io';
import 'package:chatapp/firebase/notification.dart';
...
class FacultyResultAdd extends StatefulWidget {
  const FacultyResultAdd({super.key});
...
class _FacultyResultAddState extends State<FacultyResultAdd> {
                        ...
                        if (marks.isNotEmpty) {
                          CollectionReference branchyear =
                              FirebaseFirestore.instance.collection(
                                  "/College/${state.branch}/${state.subject[selectedsub]['Year']}");
                          branchyear
                              .doc(
                                    ...
                                    onPressed: () {
                                      ...
                                      FilePicker.platform.pickFiles(
                                        ...
                                        if (result != null) {
                                          ...
                                          var file = File(uint8list as String);
  ...
  void addForStudents(CollectionReference reference) async {
    reference.doc("Roll_No").get().then((docsnap) {
      (docsnap.data()! as Map<String, DocumentReference>)
          .forEach((roll, DocumentReference ref) {
        //todo notification
        ref.get().then((snap) {
