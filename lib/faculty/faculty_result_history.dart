import 'package:chatapp/faculty/faculty_result_add.dart';
...
class FacultyResultHistory extends StatefulWidget {
  const FacultyResultHistory({super.key});
                ...
                ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      CollectionReference ref = FirebaseFirestore.instance
                          .collection(
                              "College/${subject[selectedsubject]['branch']}/${subject[selectedsubject]['year']}");
                      ref
      ...
      (docsnap.data()! as Map<String, dynamic>).forEach((roll, ref) {
        try {
          ref
              .collection('Result')
              .doc(selectedsubject)
              .update({selectedtest: FieldValue.delete()});
